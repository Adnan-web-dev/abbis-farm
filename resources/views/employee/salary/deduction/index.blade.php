                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="deduction_type" id="deduction_type" required
                                    ...
                                    <option value="Social Security System">{{__('Damages')}}</option>
                                    <option value="Health Insurance Corporation">{{__('Emergency Loan/Borrow')}}</option>
                                    <option value="Home Development Mutual Fund">{{__('Punishment')}}</option>
                                    <option value="Withholding Tax On Wages">{{__('Lateness')}}</option>
                                    <option value="Withholding Tax On Wages">{{__('Break Company Rules')}}</option>
                                    <option value="Other Statutory Deduction">{{__('Other Statutory Deduction')}}</option>
                                </select>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>{{__('Other Deduction Reasons')}} *</label>
