        ...
        <div class="table-responsive">
            <table id="transaction_show-table" class="table ">
                <thead>
                    ...
                    <tr>
                        @if (config('variable.currency_format') == 'suffix')
                            <th colspan="7" class="text-center">{{ __('Initial Balance') }}
                ...
                <tbody>
                    @foreach ($transactions as $key => $transaction)
                        <tr data-id="{{ $transaction->id }}">
                            <td>{{ $key }}</td>
                            <td>{{ $transaction->expense_reference ? $transaction->expense_date : $transaction->deposit_date }}
                            </td>
                            ...
                            @else
                                <td>{{ $transaction->expense_reference ? trans('file.Expense') : trans('file.Income') }}
                                </td>
                            @endif
                ...
                var table_table = $('#transaction_show-table').DataTable({
                    ...
                    buttons: [{
                            ...
                            customize: function(doc) {
                                ...
                                doc.content.push({
                                    text: 'Total Credit: {{ config('variable.currency') }} ' +
                                ...
                                doc.content.push({
                                    text: 'Total Debit: {{ config('variable.currency') }} ' +
                                ...
                                doc.content.push({
                                    text: 'Balance: {{ config('variable.currency') }} ' +
