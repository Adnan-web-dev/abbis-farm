        ...
        <div class="container-fluid" style="background-color:lightblue;">
            @can('store-expense')
                <button type="button" class="btn btn-info" name="create_record" id="create_record"><i
                            class="fa fa-plus"></i> {{__('Abbis Farm Daily Expense')}}</button>
            @endcan
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title">{{__('Abbis Farm Daily Expense')}}</h5>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('New Payee & Purpose')}}</label>
                                    <input type= "text" class="form-control" id="description" name="description"
                                    placeholder="{{__('Enter New Payee')}}" >
                                </div>
                            </div>
    ...
    buttons: [
        {
            ...
            customize: function (doc) {
                ...
                doc.content.push({
                    text: 'Total Expense: ' + formattedTotal,
                    alignment: 'left',
