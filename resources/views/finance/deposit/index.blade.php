                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="category" id="category" class="form-control selectpicker "
                                    ...
                                    <option value="Envato">{{trans('Deposit From Farm Mill')}}</option>
                                    <option value="salary">{{trans('Deposit From Plantation')}}</option>
                                    <option value="interest income">{{__('Deposit From CEO')}}</option>
                                    <option value="regular income">{{__('Deposit From Customer')}}</option>
                                    <option value="part time work">{{__('Deposit From Director')}}</option>
                                    <option value="other income">{{__('Other Incomes')}}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{trans('New Payer & Purpose')}}</label>
                                    <input type= "text" class="form-control" id="description" name="description"
                                    placeholder="{{__('Enter New Payer')}}" >
                                </div>
                            </div>
    ...
    buttons: [
        {
            ...
            customize: function (doc) {
                ...
                var formattedTotal = '{{ config("variable.currency") }} ' + totalAmount.toFixed(2);
