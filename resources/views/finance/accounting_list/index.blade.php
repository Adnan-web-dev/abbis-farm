        ...
        <div class="container-fluid mb-3" style="background-color:lightblue;">
            @can('store-account')
                <button type="button" class="btn btn-info" name="create_record" id="create_record"><i
                            class="fa fa-plus"></i> {{__('Add Abbis Bank Account')}}</button>
            @endcan
            @can('delete-account')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title">{{__('Add Abbis Bank Account(s)')}}</h5>
    ...
    buttons: [
        {
            ...
            customize: function (doc) {
                ...
                var formattedTotal = '{{ config("variable.currency") }} ' + totalBalance.toFixed(2);
        ...
        $('#create_record').on('click', function () {
            ...
            $('.modal-title').text('{{__('Add Abbis Bank Account')}}');
