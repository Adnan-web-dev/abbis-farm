...
@section('content')
    <section>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input class="form-control month_year date"
                                                placeholder="{{ __('Select Month') }}" readonly id="month_year"
                                    ...
                                    <div class="form-group">
                                        <div class="form-actions">
                                            ...
                                            <button id="bulk_payment" type="submit" class="filtering btn btn-primary"> <i
                                                    class="fa fa-check-square-o"></i> {{ __('BULK PAYMENT') }} </button>
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="card-title text-center">
            <h3>{{ __('Payment Info') }} <span id="details_month_year"></span></h3>
        </div>
                    ...
                    let table = $('#pay_list-table').DataTable({
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    if (
                                        '{{ config('variable.currency_format') == 'suffix' }}'
                                    ) {
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    if (data == 1) {
                                        return "<div class='badge badge-success'>{{ trans('file.Paid') }}</div>";
                                    } else {
                                        return "<div class='badge badge-danger'>{{ trans('file.Unpaid') }}</div>";
                                    }
                                }
                            },
                            {
                        ...
                        buttons: [{
                                ...
                                customize: function(doc) {
                                    ...
                                    var formattedTotal = '{{ config('variable.currency') }} ' +
