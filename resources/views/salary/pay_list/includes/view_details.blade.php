...
<div class="modal-dialog modal-dialog-centered modal-lg">
   <div class="modal-content">
       <div class="modal-header">
           <h4 class="modal-title" id="myModalLabel">{{__('Abbis Farm Employee Salary Info')}}</h4>
       ...
       <div class="modal-body">
           <div class="row">
               ...
               <div class="col-md-12">
                   <h3 class="mt-5">{{__('Employee Salary Details')}}</h3>
                   <hr>
                   <div class="card-block">
                       <div id="accordion">
                           ...
                           <div class="card mb-2">
                               <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_other_payments" aria-expanded="false"> <strong>{{__('Over Time')}}</strong></a> &nbsp; <a href="#" data-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, 0 amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a> </div>
