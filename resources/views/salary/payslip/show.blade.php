                ...
                <div class="col-md-12">
                    <div class="card mb-2">
                        <div class="card-header d-flex justify-content-between">
                            <h2 class="card-title">{{__('Abbis Farm Employee Payslip')}} <span class="text-grey text-small">({{$payslip->month_year}})</span>
                            </h2>
                            ...
                            @if($payslip->loans)
                                <div class="card  mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                ...
                                                                aria-expanded="false">
                                            <strong>{{trans('Borrow/Loan')}}</strong> </a></div>
                            ...
                            @if($payslip->other_payments)
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                ...
                                                                aria-expanded="false">
                                            <strong>{{__('Over Time')}}</strong> </a></div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>{{trans('Daily Target')}}</th>
                                                        <th>{{trans('Cost')}}</th>
                                                        <th>{{trans('Total Work Done')}}</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    @php
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table no-footer mt-0">
                                            ...
                                            <tr>
                                                @if($payslip->payment_type == 'Hourly')
                                                    <td><strong>{{__('file.Basic Salary')}} ({{__('Total')}}):</strong> <span
                                                                class="pull-right">{{$amount_hours}}</span>
                                                    </td>
                                                @else
                                                    <td><strong>{{__('file.Basic Salary')}}:</strong> <span
                                                                class="pull-right">{{$payslip->basic_salary}}</span>
                                                    </td>
                                                @endif
                                            </tr>
                                            @isset($allowance_total)
                                                <tr>
                                                    <td><strong>@lang('file.Total') @lang('file.Allowance'):</strong> <span
                                            ...
                                            @isset($commission_total )
                                                <tr>
                                                    <td><strong>@lang('file.Total') @lang('file.Commission'):</strong> <span
                                            ...
                                            @isset($payslip->pension_amount )
                                                <tr>
                                                    <td><strong>@lang('file.Pension Amount'):</strong> <span
                                            ...
                                            @isset($loan_total)
                                                <tr>
                                                    <td><strong>@lang('Monthly Payable') :</strong> <span
                                                                class="pull-right">{{$loan_total ?? 0.00}}</span></td>
                                                </tr>
                                            @endisset
                                            @isset($deduction_total)
                                                <tr>
                                                    <td><strong>@lang('file.Total') @lang('file.Deduction'):</strong> <span
                                            ...
                                            @isset($other_payment_total)
                                                <tr>
                                                    <td><strong>@lang('file.Total') @lang('Over Time'):</strong> <span
                                            ...
                                            @isset($overtime_total)
                                                <tr>
                                                    <td><strong>@lang('file.Total') @lang('file.Overtime'):</strong> <span
                                            ...
                                            <tfooter>
                                                <tr>
                                                    @if(config('variable.currency_format') =='suffix')
                                                        <th class="text-dark"><strong>@lang('Paid Amount'):</strong> <span
