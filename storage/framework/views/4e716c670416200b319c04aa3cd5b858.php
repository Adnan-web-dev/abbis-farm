                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select name="relation" id="contact_relation" required class="form-control selectpicker"
                                    ...
                                    <option value="self"><?php echo e(trans('Pastor/Alfa (Clergy)')); ?></option>
                                    <option value="parent"><?php echo e(trans('Parent')); ?></option>
                                    ...
                                    <option value="in laws"><?php echo e(__('Friend')); ?></option>
                                </select>
                            </div>
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/emergency_contacts/index.blade.php ENDPATH**/ ?>