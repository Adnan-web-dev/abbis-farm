                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select class="form-control ss selectpicker dynamic" name="filter_company"
                                                id="company_id" data-dependent="department_name" data-placeholder="Company"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select class="form-control selectpicker default_dept" name="filter_department"
                                                id="department_id" data-placeholder="Department" required tabindex="-1"
                                                aria-hidden="true">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input class="form-control month_year date"
                                                placeholder="<?php echo e(__('Select Month')); ?>" readonly id="month_year"
                                                name="month_year" type="text" value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <div class="form-group">
                                        <div class="form-actions">
                                            <button id="payslip_filter" type="submit" class="filtering btn btn-primary"> <i
                                                    class="fa fa-search"></i> <?php echo e(trans('file.Search')); ?> </button>
                                            <button id="bulk_payment" type="submit" class="filtering btn btn-primary"> <i
                                                    class="fa fa-check-square-o"></i> <?php echo e(__('BULK PAYMENT')); ?> </button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    let table = $('#pay_list-table').DataTable({
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    if (
                                        '<?php echo e(config('variable.currency_format') == 'suffix'); ?>'
                                    ) {
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    if (data == 1) {
                                        return "<div class='badge badge-success'><?php echo e(trans('file.Paid')); ?></div>";
                                    } else {
                                        return "<div class='badge badge-danger'><?php echo e(trans('file.Unpaid')); ?></div>";
                                    }
                                }
                            },
                            {
                        ...
                        buttons: [{
                                ...
                                customize: function(doc) {
                                    ...
                                    var netSalaryIndex =
                                    4; // Assuming the net_salary column index is 4
                                    var tableData = table.data().toArray();

                                    for (var i = 0; i < tableData.length; i++) {
                                        totalNetSalary += parseFloat(tableData[i].net_salary
                                            .toString().replace(/[\$,]/g, ''));
                                    }

                                    // Format the total net salary with currency
                                    var formattedTotal = '<?php echo e(config('variable.currency')); ?> ' +
                                        totalNetSalary.toFixed(2);

                                    // Add total net salary to the PDF
                                    doc.content.push({
                                        text: 'Total Net Salary: ' + formattedTotal,
                                        alignment: 'left',
                                        margin: [0, 10, 0,
                                            0
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.payment_type_error) {
                            html = '<div class="alert alert-danger">' + data.payment_type_error +
                                '</div>';
                            $('#payment_type_error').html(html).slideDown(300).delay(5000).slideUp(
                                300);
                        }
                        if (data.error) {
                        ...
                        $('#bulk_payment_result').html(html).slideDown(300).delay(5000).slideUp(
                            300);
                    }
                });
                ...
                if ($(this).val() !== '') {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $('.default_dept').prepend(
                                '<option value="0" selected><?php echo e(__('All Departments')); ?></option>'
                            );
                            $('select').selectpicker();
                        }
                    });
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\abbisfarm\resources\views/salary/pay_list/index.blade.php ENDPATH**/ ?>