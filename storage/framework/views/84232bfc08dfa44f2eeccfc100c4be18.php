                ...
                <div class="col-md-12">
                    <div class="card mb-2">
                        <div class="card-header d-flex justify-content-between">
                            <h2 class="card-title"><?php echo e(__('Abbis Farm Employee Payslip')); ?> <span class="text-grey text-small">(<?php echo e($payslip->month_year); ?>)</span>
                            </h2>
                            ...
                            <?php if($payslip->loans): ?>
                                <div class="card  mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                ...
                                                                aria-expanded="false">
                                            <strong><?php echo e(trans('Borrow/Loan')); ?></strong> </a></div>
                            ...
                            <?php if($payslip->other_payments): ?>
                                <div class="card mb-2">
                                    <div class="card-header"><a class="text-dark collapsed d-block"
                                                                ...
                                                                aria-expanded="false">
                                            <strong><?php echo e(__('Over Time')); ?></strong> </a></div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(trans('Total Work Done')); ?></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <?php
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table no-footer mt-0">
                                            ...
                                            <tr>
                                                <?php if($payslip->payment_type == 'Hourly'): ?>
                                                    <td><strong><?php echo e(__('file.Basic Salary')); ?> (<?php echo e(__('Total')); ?>):</strong> <span
                                                                class="pull-right"><?php echo e($amount_hours); ?></span>
                                                    </td>
                                                <?php else: ?>
                                                    <td><strong><?php echo e(__('file.Basic Salary')); ?>:</strong> <span
                                                                class="pull-right"><?php echo e($payslip->basic_salary); ?></span>
                                                    </td>
                                                <?php endif; ?>
                                            </tr>
                                            <?php if(isset($allowance_total)): ?>
                                                <tr>
                                                    <td><strong><?php echo app('translator')->get('file.Total'); ?> <?php echo app('translator')->get('file.Allowance'); ?>:</strong> <span
                                            ...
                                            <?php if(isset($commission_total )): ?>
                                                <tr>
                                                    <td><strong><?php echo app('translator')->get('file.Total'); ?> <?php echo app('translator')->get('file.Commission'); ?>:</strong> <span
                                            ...
                                            <?php if(isset($payslip->pension_amount )): ?>
                                                <tr>
                                                    <td><strong><?php echo app('translator')->get('file.Pension Amount'); ?>:</strong> <span
                                            ...
                                            <?php if(isset($loan_total)): ?>
                                                <tr>
                                                    <td><strong><?php echo app('translator')->get('Monthly Payable'); ?> :</strong> <span
                                                                class="pull-right"><?php echo e($loan_total ?? 0.00); ?></span></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if(isset($deduction_total)): ?>
                                                <tr>
                                                    <td><strong><?php echo app('translator')->get('file.Total'); ?> <?php echo app('translator')->get('file.Deduction'); ?>:</strong> <span
                                            ...
                                            <?php if(isset($other_payment_total)): ?>
                                                <tr>
                                                    <td><strong><?php echo app('translator')->get('file.Total'); ?> <?php echo app('translator')->get('Over Time'); ?>:</strong> <span
                                            ...
                                            <?php if(isset($overtime_total)): ?>
                                                <tr>
                                                    <td><strong><?php echo app('translator')->get('file.Total'); ?> <?php echo app('translator')->get('file.Overtime'); ?>:</strong> <span
                                            ...
                                            <tfooter>
                                                <tr>
                                                    <?php if(config('variable.currency_format') =='suffix'): ?>
                                                        <th class="text-dark"><strong><?php echo app('translator')->get('Paid Amount'); ?>:</strong> <span
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/salary/payslip/show.blade.php ENDPATH**/ ?>