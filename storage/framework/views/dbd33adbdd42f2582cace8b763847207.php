        ...
        <div class="table-responsive" style="background-color:lightblue;">
            <table id="commission-table" class="table ">
                ...
                <tr>
                    ...
                    <th><?php echo e(__('Commission Purpose')); ?></th>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="commission_sample_form" class="form-horizontal" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Commission Purpose/Reason')); ?> *</label>
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/salary/commission/index.blade.php ENDPATH**/ ?>