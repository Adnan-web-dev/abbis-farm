            ...
            <table id="deposit-table" class="table ">
                ...
                <tr>
                    ...
                    <th><?php echo e(trans('file.Payer')); ?></th>
                     <th><?php echo e(trans('New Payer & Purpose')); ?></th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="category" id="category" class="form-control selectpicker "
                                    ...
                                    <option value="Envato"><?php echo e(trans('Deposit From Farm Mill')); ?></option>
                                    <option value="salary"><?php echo e(trans('Deposit From Plantation')); ?></option>
                                    <option value="interest income"><?php echo e(__('Deposit From CEO')); ?></option>
                                    <option value="regular income"><?php echo e(__('Deposit From Customer')); ?></option>
                                    <option value="part time work"><?php echo e(__('Deposit From Director')); ?></option>
                                    <option value="other income"><?php echo e(__('Other Incomes')); ?></option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(trans('New Payer & Purpose')); ?></label>
                                    <input type= "text" class="form-control" id="description" name="description"
                                    placeholder="<?php echo e(__('Enter New Payer')); ?>" >
                                </div>
                            </div>
    ...
    buttons: [
        {
            ...
            customize: function (doc) {
                ...
                var totalAmount = 0;
                var tableData = table_table.rows({ filter: 'applied' }).data().toArray();

                for (var i = 0; i < tableData.length; i++) {
                    var amountString = tableData[i].amount;
                    var amount = parseFloat(amountString.replace(/[\$,]/g, ''));
                    totalAmount += isNaN(amount) ? 0 : amount;
                }

                // Format the total amount with currency
                var formattedTotal = '<?php echo e(config("variable.currency")); ?> ' + totalAmount.toFixed(2);

                // Add total amount to the PDF
                doc.content.push({
                    text: 'Total Deposit: ' + formattedTotal,
                    alignment: 'left',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\abbisfarm\resources\views/finance/deposit/index.blade.php ENDPATH**/ ?>