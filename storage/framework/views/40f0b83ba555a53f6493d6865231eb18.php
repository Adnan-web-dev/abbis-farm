    ...
    <div class="mb-3" style="background-color:lightblue;">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('set-salary')): ?>
            <button type="button" class="btn btn-info" name="create_record" id="create_other_payment_record"><i
                        class="fa fa-plus"></i><?php echo e(__('Add Over Time')); ?></button>
        <?php endif; ?>
    </div>
        ...
        <div class="table-responsive" style="background-color:lightblue;">
            <table id="other_payment-table" class="table ">
                ...
                <tr>
                    ...
                    <th><?php echo e(trans('Overtime Purpose')); ?></th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('Add Over Time')); ?></h5>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="other_payment_sample_form" class="form-horizontal" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(trans('Overtime Details')); ?> *</label>
                                <input type="text" name="other_payment_title" id="other_payment_title"
                                       placeholder=<?php echo e(trans('Enter Overtime Details')); ?>
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/salary/other_payment/index.blade.php ENDPATH**/ ?>