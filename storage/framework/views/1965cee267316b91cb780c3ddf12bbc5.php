    ...
    <div class="table-responsive">
        <table id="document-table" class="table ">
            ...
            <tr>
                ...
                <th><?php echo e(trans('Other Document name')); ?></th>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="document_sample_form" class="form-horizontal" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(trans('Other Document(s) Name')); ?> *</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(trans('Document Details (e.g State Issued)')); ?></label>
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/documents/index.blade.php ENDPATH**/ ?>