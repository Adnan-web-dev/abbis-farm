        ...
        <div class="table-responsive" style="background-color:lightblue;">
            <table id="allowance-table" class="table ">
                ...
                <tr>
                    ...
                    <th><?php echo e(__('Allowance Purpose')); ?></th>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="allowance_sample_form" class="form-horizontal" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Allowance Purpose')); ?> *</label>
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/salary/allowance/index.blade.php ENDPATH**/ ?>