                    ...
                    <form method="bank_code" id="bank_account_sample_form" class="form-horizontal" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Account Type (e.g Current)')); ?> *</label>
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Bank Code (e.g GTB)')); ?> *</label>
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Bank Branch (e.g Lagos)')); ?> *</label>
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/bank_account/index.blade.php ENDPATH**/ ?>