            ...
            <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('salary_loan.show',$employee)); ?>" id="salary_loan-tab"
                       ...
                       aria-controls="Salary_loan" aria-selected="false"><?php echo e(trans('Borrow/Loan')); ?></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('other_payment.show',$employee)); ?>" id="other_payment-tab"
                       ...
                       aria-controls="Other_payment" aria-selected="false"><?php echo e(__('Over Time')); ?></a>
                </li>
                <li class="nav-item">
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/salary/index.blade.php ENDPATH**/ ?>