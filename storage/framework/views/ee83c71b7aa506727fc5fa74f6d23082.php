...
$('#bank_account-table').DataTable().clear().destroy();
    ...
    $('#create_bank_account_record').click(function () {
        ...
        $('.modal-title').text("<?php echo e(__('Add Employee Bank Account')); ?>");
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/bank_account/index_js.blade.php ENDPATH**/ ?>