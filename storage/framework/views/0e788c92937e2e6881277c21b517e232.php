   ...
   var table_table = $('#other_payment-table').DataTable({
    ...
    $('#create_other_payment_record').click(function () {
        ...
        $('.modal-title').text('<?php echo e(__('Add Over Time')); ?>');
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/salary/other_payment/index_js.blade.php ENDPATH**/ ?>