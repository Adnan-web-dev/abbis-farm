...
table, th, td, tr {
  ...
  border-collapse: collapse;
        ...
        <div class="container-fluid mb-3" style="background-color:lightblue;">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('store-account')): ?>
                <button type="button" class="btn btn-info" name="create_record" id="create_record"><i
                            class="fa fa-plus"></i> <?php echo e(__('Add Abbis Bank Account')); ?></button>
            <?php endif; ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('Add Abbis Bank Account(s)')); ?></h5>
    ...
    buttons: [
        {
            ...
            customize: function (doc) {
                ...
                for (var i = 0; i < tableData.length; i++) {
                    var balanceString = tableData[i].account_balance;
                    var balance = parseFloat(balanceString.replace(/[\$,]/g, ''));
                    totalBalance += isNaN(balance) ? 0 : balance;
                }

                // Format the total balance with currency
                var formattedTotal = '<?php echo e(config("variable.currency")); ?> ' + totalBalance.toFixed(2);

                // Add total balance to the PDF
                doc.content.push({
                    text: 'Total Account Balance: ' + formattedTotal,
                    alignment: 'left',
        ...
        $('#create_record').on('click', function () {
            ...
            $('.modal-title').text('<?php echo e(__('Add Abbis Bank Account')); ?>');
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\abbisfarm\resources\views/finance/accounting_list/index.blade.php ENDPATH**/ ?>