...
<section>
    ...
    <div class="container-fluid mb-3">
        <h4 class="font-weight-bold mt-3"><?php echo app('translator')->get('file.Performance Indicator'); ?></h4>
        <div id="success_alert" role="alert"></div>
        <br>

        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModalForm"><i class="fa fa-plus"></i><?php echo e(__('file.Add New Indicator')); ?></button>
        ...
        <table id="indicatorTable" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo app('translator')->get('file.Added By'); ?></th>
                    <th><?php echo app('translator')->get('file.Created At'); ?></th>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/performance/indicator/index.blade.php ENDPATH**/ ?>