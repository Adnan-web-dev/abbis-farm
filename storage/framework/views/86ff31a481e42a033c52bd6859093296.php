                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="deduction_type" id="deduction_type" required
                                    ...
                                    <option value="Social Security System"><?php echo e(__('Damages')); ?></option>
                                    <option value="Health Insurance Corporation"><?php echo e(__('Emergency Loan/Borrow')); ?></option>
                                    <option value="Home Development Mutual Fund"><?php echo e(__('Punishment')); ?></option>
                                    <option value="Withholding Tax On Wages"><?php echo e(__('Lateness')); ?></option>
                                    <option value="Withholding Tax On Wages"><?php echo e(__('Break Company Rules')); ?></option>
                                    <option value="Other Statutory Deduction"><?php echo e(__('Other Statutory Deduction')); ?></option>
                                </select>
                            </div>
                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Other Deduction Reasons')); ?> *</label>
...
<?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/salary/deduction/index.blade.php ENDPATH**/ ?>