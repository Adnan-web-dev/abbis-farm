                                    ...
                                    <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('immigrations.show',$employee)); ?>"
                                               ...
                                               aria-selected="false"><?php echo e(trans('Immigration (Foreigner Workers)')); ?></a>
                                        </li>
                                        <li class="nav-item">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/employee/dashboard.blade.php ENDPATH**/ ?>