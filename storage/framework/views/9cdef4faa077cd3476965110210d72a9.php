...
<section>
    ...
    <div class="container-fluid mb-3">
        <h4 class="font-weight-bold mt-3"><?php echo app('translator')->get('file.Goal Tracking'); ?></h4>
        <div id="success_alert" role="alert"></div>
        <br>

        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModalForm"><i class="fa fa-plus"></i><?php echo e(__('file.Add New Goal')); ?></button>
        <button type="button" class="btn btn-danger" id="bulk_delete"><i class="fa fa-minus-circle"></i><?php echo e(__('file.Bulk Delete')); ?></button>
    </div>
        ...
        <table id="goalTrackingTable" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo app('translator')->get('file.Goal Type'); ?></th>
                    <th><?php echo app('translator')->get('file.Company'); ?></th>
                    <th><?php echo app('translator')->get('file.Target Achievement'); ?></th>
                    <th><?php echo app('translator')->get('file.Start Date'); ?></th>
                    <th><?php echo app('translator')->get('file.End Date'); ?></th>
                    <th><?php echo app('translator')->get('file.Progress'); ?></th>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abbisfar/payroll.abbisfarmltd.com/resources/views/performance/goal-tracking/index.blade.php ENDPATH**/ ?>